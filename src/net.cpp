...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Tatsumicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"tatsumicoin.freeddns.org", "185.103.199.75"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"tatsumicointools.com", "testnet-seed.tatsumicointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Tatsumicoin is probably already running."), addrBind.ToString().c_str());
        else
